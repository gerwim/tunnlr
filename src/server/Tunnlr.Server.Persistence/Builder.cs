...
public class Builder : IBuilder
{
    ...
    {
        builder.Services.AddDbContext<TunnlrServerDbContext, SqliteServerDbContext>(options =>
        {
    ...
    {
        builder.Services.AddDbContext<TunnlrServerDbContext, PostgreSqlServerDbContext>(options =>
        {
            // Create a custom connection string for each Sqlite database since Sqlite does not support schemas
